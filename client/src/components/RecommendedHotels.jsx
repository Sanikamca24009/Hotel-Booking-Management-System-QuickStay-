...
const RecommendedHotels = () => {
    ...
    const filterHotels = () => {
        // Guard: only include rooms where hotel is a populated object (has a city field)
        const filteredHotels = rooms.slice().filter(room => room.hotel && typeof room.hotel === 'object' && searchedCities.includes(room.hotel.city));
