...
const RoomDetails = () => {
    const { id } = useParams();
    const { facilityIcons, rooms, user, getToken, axios, navigate } = useAppContext();
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            // Login gate — require user to be signed in
            if (!user) {
        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    <img className='h-14 w-14 md:h-18 md:w-18 rounded-full object-cover' src={room.hotel?.owner?.image || 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200'} alt='Host' />
                    <div>
